...
public class MembershipRequestPersistenceImpl extends BasePersistenceImpl<MembershipRequest>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_G_U = new FinderPath(MembershipRequestModelImpl.ENTITY_CACHE_ENABLED,
			MembershipRequestModelImpl.FINDER_CACHE_ENABLED,
			MembershipRequestImpl.class,
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_G_U = new FinderPath(MembershipRequestModelImpl.ENTITY_CACHE_ENABLED,
			MembershipRequestModelImpl.FINDER_CACHE_ENABLED,
			MembershipRequestImpl.class,
	 ...
	 */
	@Override
	public List<MembershipRequest> findByG_U(long groupId, long userId)
		throws SystemException {
	 ...
	 */
	@Override
	public MembershipRequest findByG_U_First(long groupId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipRequestException, SystemException {
		MembershipRequest membershipRequest = fetchByG_U_First(groupId, userId,
				orderByComparator);
	 ...
	 */
	@Override
	public MembershipRequest fetchByG_U_First(long groupId, long userId,
		OrderByComparator orderByComparator) throws SystemException {
		List<MembershipRequest> list = findByG_U(groupId, userId, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public MembershipRequest findByG_U_Last(long groupId, long userId,
		OrderByComparator orderByComparator)
		throws NoSuchMembershipRequestException, SystemException {
		MembershipRequest membershipRequest = fetchByG_U_Last(groupId, userId,
				orderByComparator);
	 ...
	 */
	@Override
	public MembershipRequest fetchByG_U_Last(long groupId, long userId,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<MembershipRequest> list = findByG_U(groupId, userId, count - 1,
				count, orderByComparator);
	 ...
	 */
	@Override
	public MembershipRequest[] findByG_U_PrevAndNext(long membershipRequestId,
		...
		try {
			...
			array[0] = getByG_U_PrevAndNext(session, membershipRequest,
					groupId, userId, orderByComparator, true);

			array[1] = membershipRequest;

			array[2] = getByG_U_PrevAndNext(session, membershipRequest,
	...
	protected MembershipRequest getByG_U_PrevAndNext(Session session,
	...
	public void removeByG_U(long groupId, long userId)
		throws SystemException {
		for (MembershipRequest membershipRequest : findByG_U(groupId, userId,
				QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
			remove(membershipRequest);
		}
	}
